...
interface RequestWithOperatorDashboardScope extends Request {
  user?: JwtPayload;
  operatorDashboardScope?: OperatorDashboardScope;
}

@Injectable()
export class OperatorDashboardScopeGuard implements CanActivate {
  ...
  async canActivate(context: ExecutionContext): Promise<boolean> {
    ...
    request.operatorDashboardScope = {
      tenantId: user.tenantId,
      membershipId: user.membershipId,
      role: Role.OPERADOR,
      empresaIds,
